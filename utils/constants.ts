export const INTRO_SCREEN_00 = {
  title: "Elevate Your Intelligence",
  description:
    "Welcome to Sura-ai, where advanced AI features meet human ingenuity. Get ready to experience the future of intelligent assistance.",
};
